...
int main()
{
    ...
    constexpr string normaImtString = "Норма ИМТ с учетом возраста и пола - ";
    if (Gender)
    {
        if ((Age > 19) && (Age < 24)) {
    ...
    // Числовые диапазоны типов данных
    cout << "Числовые диапазоны в десятичной системе: " << endl;
    cout << "unsigned short: от " << numeric_limits<unsigned short>::min() << " до " << numeric_limits<unsigned short>::max() << endl;
    cout << "short: от " << numeric_limits<short>::min() << " до " << numeric_limits<short>::max() << endl;
    cout << "unsigned int: от " << numeric_limits<unsigned int>::min() << " до " << numeric_limits<unsigned int>::max() << endl;
    cout << "int: от " << numeric_limits<int>::min() << " до " << numeric_limits<int>::max() << endl;
    cout << "unsigned long: от " << numeric_limits<unsigned long>::min() << " до " << numeric_limits<unsigned long>::max() << endl << endl;

    cout << "Числовые диапазоны в шестнадцатиричной системе: " << endl;
    cout << "unsigned short: от " << hex << numeric_limits<unsigned short>::min() << " до " << numeric_limits<unsigned short>::max() << endl;
    cout << "short: от " << hex << numeric_limits<short>::min() << " до " << numeric_limits<short>::max() << endl;
    cout << "unsigned int: от " << hex << numeric_limits<unsigned int>::min() << " до " << numeric_limits<unsigned int>::max() << endl;
    cout << "int: от " << hex << numeric_limits<int>::min() << " до " << numeric_limits<int>::max() << endl;
    cout << "unsigned long: от " << hex << numeric_limits<unsigned long>::min() << " до " << numeric_limits<unsigned long>::max() << endl << endl;

    cout << "Числовые диапазоны в восьмеричной системе: " << endl;
    cout << "unsigned short: от " << oct << numeric_limits<unsigned short>::min() << " до " << numeric_limits<unsigned short>::max() << endl;
    cout << "short: от " << oct << numeric_limits<short>::min() << " до " << numeric_limits<short>::max() << endl;
    cout << "unsigned int: от " << oct << numeric_limits<unsigned int>::min() << " до " << numeric_limits<unsigned int>::max() << endl;
    cout << "int: от " << oct << numeric_limits<int>::min() << " до " << numeric_limits<int>::max() << endl;
    cout << "unsigned long: от " << oct << numeric_limits<unsigned long>::min() << " до " << numeric_limits<unsigned long>::max() << endl << endl;

    constexpr int bits = 8;
    cout << "Числовые диапазоны в двоичной системе: " << endl;
    cout << "unsigned short: от " << bitset<sizeof(unsigned short) * bits>(numeric_limits<unsigned short>::min()) << " до " << bitset<sizeof(unsigned short) * bits>(numeric_limits<unsigned short>::max()) << endl;
    cout << "short: от " << bitset<sizeof(short) * bits>(numeric_limits<short>::min()) << " до " << bitset<sizeof(short) * bits>(numeric_limits<short>::max()) << endl;
    cout << "unsigned int: от " << bitset<sizeof(unsigned int) * bits>(numeric_limits<unsigned int>::min()) << " до " << bitset<sizeof(unsigned int) * bits>(numeric_limits<unsigned int>::max()) << endl;
    cout << "int: от " << bitset<sizeof(int) * bits>(numeric_limits<int>::min()) << " до " << bitset<sizeof(int) * bits>(numeric_limits<int>::max()) << endl;
    cout << "unsigned long: от " << bitset<sizeof(unsigned long) * bits>(numeric_limits<unsigned long>::min()) << " до " << bitset<sizeof(unsigned long) * bits>(numeric_limits<unsigned long>::max()) << endl << endl;
