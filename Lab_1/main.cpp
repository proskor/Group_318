...
Разработчики программы 1. Проскоряков Алексей
...
// Задание 3
  ...
  // Задача №2
    ...
    cout << "Ускорение (м/с) = " << fixed << setprecision(2) << Acceleration << endl << endl;
  // Задача №3
    float LenghtCircle;
    double RadiusCircle;
    ...
    cout << "Радиус круга (см) = " << fixed << setprecision(4) << RadiusCircle << endl << endl;
    return 0;
}
